...
<style>
    /* --- Layout Styles --- */
    body { background-color: #f8fafd; font-family: 'Kanit', sans-serif; margin: 0; overflow-x: hidden; }
    .main { display: flex; width: 100%; min-height: 100vh; }
    
    /* Sidebar Styling */
    .sidebar-wrapper { width: 250px; min-width: 250px; flex-shrink: 0; background: #fff; border-right: 1px solid #eee; z-index: 1000; transition: 0.3s; }
    
    /* Content Styling */
    .content-container { flex-grow: 1; padding: 30px; width: calc(100% - 250px); }
    
    /* Custom Styles for Edit Page */
    .card-custom { border: none; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); }
    .header-title { color: #2c3e50; font-weight: 700; margin-bottom: 20px; }
    .form-label { font-weight: 600; color: #555; }
    .info-label { color: #888; font-size: 0.9rem; }
    .info-value { font-weight: 500; color: #333; font-size: 1.05rem; }
    ...
    @media (max-width: 992px) {
        ...
        .content-container { width: 100%; padding: 15px; padding-top: 60px; }
